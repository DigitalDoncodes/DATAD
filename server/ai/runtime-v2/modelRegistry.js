...
const MODELS = {
  ...
  'meta/llama-4-maverick-17b-128e-instruct': {
    provider: 'nvidia',
    // Slug corrected against the live NVIDIA catalogue — the short form 404s.
    // Same model, so the capability scores below still hold.
    // Verify with: node server/scripts/verifyModelRegistry.js
  ...
  'mistralai/mistral-large-3-675b-instruct-2512': {
    provider: 'nvidia',
    // Slug corrected against the live catalogue (was 'mistralai/mistral-large-3-675b-instruct-2512').
  ...
  'minimaxai/minimax-m2.7': {
    provider: 'nvidia',
    // Vendor namespace corrected: 'minimax/' -> 'minimaxai/' in the live catalogue.
  ...
  'z-ai/glm-5.2': {
    provider: 'nvidia',
    // Vendor namespace corrected: 'glm-5/' -> 'z-ai/' in the live catalogue.
    model: 'z-ai/glm-5.2',
    parameters: '744b',
    contextWindow: 256000,
    maxTokens: 8192,
  ...
  'nvidia/bge-m3': {
    provider: 'nvidia',
    // Vendor namespace corrected: BGE-M3 is served under 'baai/', not 'nvidia/'.
    model: 'baai/bge-m3',
    parameters: 'unknown',
    contextWindow: 8192,
    maxTokens: 8192,
  ...
  'meta/codellama-70b-instruct': {
    provider: 'nvidia',
    // Slug corrected: the live catalogue drops the '-instruct' suffix.
    model: 'meta/codellama-70b',
    parameters: '70b',
    contextWindow: 16384,
    maxTokens: 4096,
